...
export const VISUAL_RULES: Record<string, RuleOption[]> = {
  Electronics: [
    { id: 'opt1', description: 'Συνδυασμός Α', parts: [{ code: 'H', type: 'full' }, { code: 'ANY', type: 'full', label: 'Υ ή Σ' }, { code: 'ANY', type: 'half', label: '+ ½ Αλλη' }] },
  ...
  Informatics: [
    { id: 'opt1', description: 'Συνδυασμός Α', parts: [{ code: 'Y', type: 'full' }, { code: 'L', type: 'full' }, { code: 'ANY', type: 'half', label: '+ ½ Αλλη' }] },
  ...
  Communications: [
    { id: 'opt1', description: 'Συνδυασμός Α', parts: [{ code: 'T', type: 'full' }, { code: 'D', type: 'full' }, { code: 'ANY', type: 'half', label: '+ ½ Αλλη' }] },
  ...
  Energy: [
    { id: 'opt1', description: 'Συνδυασμός Α', parts: [{ code: 'E', type: 'full' }, { code: 'Z', type: 'full' }, { code: 'ANY', type: 'half', label: '+ ½ Αλλη' }] },
