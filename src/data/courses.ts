...
export const courses: Course[] = [
    ...
    },
    {
        ...
        type: 'elective',
        is_flow_compulsory: false,
        description: "Μοντέλο ελεύθερων ηλεκτρονίων. Ιδιότητες θερμικής ισορροπίας. Ιδιότητες μεταφοράς. Κρυσταλλικά πλέγματα. Περίθλαση ακτινοβολίας από κρυστάλλους. Αντίστροφο πλέγμα. Δεσμοί στους κρυστάλλους. Ταξινόμηση των κρυστάλλων. Κίνηση ηλεκτρονίων σε περιοδικό δυναμικό. Θεώρημα Bloch, Ενεργειακές ζώνες. Ημιαγωγοί. Ενεργός μάζα, Πυκνότητα Καταστάσεων, Συγκεντρώσεις φορέων, Ενδογενείς ημιαγωγοί, Νόμος δράσης των μαζών, Εξωγενείς ημιαγωγοί, Συνθήκη ουδετερότητας, Επίπεδο Fermi, Επαφή p-n χωρίς εξωτερική τάση. Ταλαντώσεις πλέγματος. Φωτόνια, Σχέσεις διασποράς, Θερμικές ιδιότητες. Επιφάνειες. Άμορφα υλικά. Το μάθημα περιλαμβάνει εργαστηριακή εξάσκηση. Διδάσκοντες: Β. Γιαννόπαπας",
        lecture_hours: 4,
        lab_hours: 0
    },
    {
    ...
    },
    {
        ...
        type: 'elective',
        is_flow_compulsory: false,
        description: "Το μάθημα περιλαμβάνει εργαστηριακές ασκήσεις πάνω στα επόμενα θέματα: Προγραμματισμός σε assembly των μικροεπεξεργαστών 8085 και 80x86. Διαδικασίες εισόδου-εξόδου δεδομένων. Χρήση Διακοπών. Διασύνδεση μικροεπεξεργαστών με εξωτερικές μονάδες (interfacing) και συσκευές. Σχεδίαση αυτοματισμών με βάση μικροεπεξεργαστές. Προγραμματισμός Μικροελεγκτών. Έλεγχος περιφερειακών Μικροελεγκτών και εφαρμογές. Διδάσκοντες: Σ. Ξύδης, Κ. Πεκμεστζή, Δ. Σούντρης, Σ. Κοκόσης (Ε.ΔΙ.Π.)",
        lecture_hours: 1,
        lab_hours: 3
    },
    {
    ...
    },
    {
        ...
        professors: "Ά.-Ε. Δημέας , Ν. Χατζηαργυρίου, Ν. Κιμουλάκης (Ε.ΔΙ.Π.)",
        lecture_hours: 3,
        lab_hours: 1
    },
    {
    ...
    },
    {
        ...
        type: 'elective',
        is_flow_compulsory: false,
        description: "Συγκρότηση και αρχές λειτουργίας των συστημάτων ηλεκτρικών μηχανών. Μαθηματικά μοντέλα και προσομοίωση συστημάτων ηλεκτρικών μηχανών συνεχούς και εναλλασσομένου ρεύματος. Έλεγχος συστημάτων ηλεκτρικών μηχανών συνεχούς και εναλλασσομένου ρεύματος. Ευστάθεια συστημάτων ηλεκτρικών μηχανών. Έλεγχος επιδόσεων λειτουργίας και έλεγχος ποιότητας λειτουργίας συστημάτων ηλεκτρικών μηχανών. Τεχνικές ελέγχου των συστημάτων ηλεκτρικών μηχανών. Συστήματα ελέγχου ηλεκτρικών μηχανών συνεχούς και εναλλασσομένου ρεύματος σε ανοικτό βρόχο και σε κλειστό βρόχο. Έλεγχος με προσανατολισμό του πεδίου του συστήματος ασύγχρονου κινητήρα. Έλεγχος συστήματος ανάκτησης της ισχύος. Ψηφιακά συστήματα ελέγχου ηλεκτρικών μηχανών. Ψηφιακοί ελεγκτές. Αλγόριθμοι ελέγχου. Έλεγχος με μικροϋπολογιστές και μικροελεγκτές. Προγραμματιζόμενοι λογικοί ελεγκτές PLC σε συστήματα ηλεκτρικής κίνησης. Βιομηχανικές εφαρμογές των ελεγχόμενων συστημάτων ηλεκτρικών μηχανών: συστήματα ελέγχου της επιτάχυνσης, της ταχύτητας, της θέσης, της ισχύος, κ.α.. Εργαστηριακές ασκήσεις.",
        professors: "Α. Αντωνόπουλος",
        lecture_hours: 2,
        lab_hours: 2
    },
    ...
    },
    {
        ...
        professors: "Ά.-Ε. Δημέας , Β. Νικολαΐδης , Ν. Χατζηαργυρίου",
        lecture_hours: 3,
        lab_hours: 1
    },
    {
    ...
    },
    {
        ...
        professors: "Ά.-Ε. Δημέας , Γ. Κορρές, Ν. Κιμουλάκης (Ε.ΔΙ.Π.)",
        lecture_hours: 2,
        lab_hours: 2
    },
    {
