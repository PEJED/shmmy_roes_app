        ...
        <div className="p-4 sm:p-5 flex-grow flex flex-col sm:flex-row items-start sm:items-center justify-between w-full relative gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-6 shrink-0 w-full sm:w-auto justify-between sm:justify-end mt-2 sm:mt-0 pt-3 sm:pt-0 border-t sm:border-t-0 border-gray-100/60">
             ...
             <button
               ...
               className="p-1.5 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-colors shrink-0 z-30"
               title="Λεπτομέρειες"
             >
          ...
          {isDisabled && tooltip && (
            <div className="absolute inset-0 z-20 hidden group-hover:flex items-center justify-center bg-gray-900/10 backdrop-blur-[1px] rounded-2xl pointer-events-none">
